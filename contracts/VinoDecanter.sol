...
// VinoDecanter helps your migrate your existing Uniswap LP tokens to VinoSwap LP ones
contract VinoDecanter {
    ...
    function migrate(
        ...
        require(deadline >= block.timestamp, 'VinoSwap: EXPIRED');
    ...
    function removeLiquidity(
        ...
        require(amountA >= amountAMin, 'VinoDecanter: INSUFFICIENT_A_AMOUNT');
        require(amountB >= amountBMin, 'VinoDecanter: INSUFFICIENT_B_AMOUNT');
    }
